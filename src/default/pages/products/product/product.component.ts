...
export class ProductComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  public selectImage(image, i) {
    ...
    this.image = this.imagePath + '?path=' + image.containerName + '&name=' + image.image + '&width=390&height=390';
    this.changeDetectRef.detectChanges();
    this.zoomImage = this.imagePath + '?path=' + image.containerName + '&name=' + image.image + '&width=660&height=660';
  }
