import { ChangeDetectorRef, Component, OnDestroy, OnInit, ViewChild, Inject, PLATFORM_ID } from '@angular/core';
...
export class CheckoutComponent implements OnInit, OnDestroy {
  ...
  initCheckoutForm() {
    ...
    this.phone = new FormControl(
      '',
      Validators.compose([Validators.required, Validators.pattern(mobileValidationPattern)])
    );
