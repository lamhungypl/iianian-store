...
export const ActionTypes = {
  ...
  GET_ACTIVE_CATEGORY_SUCCESS: type('[active_category] get active_category list success'),
  GET_ACTIVE_CATEGORY_FAIL: type('[active_category] get active_category list fail'),
  ...
  GET_SERVICE_CATEGORY_SUCCESS: type('[service category] category list success'),
